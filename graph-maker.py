...
if st.button("🔄 Refresh with New Units", type="secondary", use_container_width=True):
    st.success("Labels updated. You can now edit data and generate graph.")
...
if st.button("🚀 Generate Graph", type="primary", use_container_width=True):
    ...
    try:
        ...
        st.info("Tip: For Box Plot and Histogram, Y column must contain only numbers.")

st.caption("Change X/Y labels → Click 'Refresh with New Units' → Edit data → Generate Graph")
